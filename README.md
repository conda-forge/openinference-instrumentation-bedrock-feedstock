About openinference-instrumentation-bedrock-feedstock
=====================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/openinference-instrumentation-bedrock-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/openinference-instrumentation-bedrock-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add openinference-instrumentation-bedrock
# for installing globally
pixi global install openinference-instrumentation-bedrock
```
...
It is possible to list all of the versions of `openinference-instrumentation-bedrock` available on your platform:
...
```
pixi search openinference-instrumentation-bedrock --channel conda-forge
```
